        ...
        <>
            <section className="welcomepage__footer--bottom">
                <div className="welcomepage__footer--bottom-text">
                    <h2 className='welcomepage__footer--bottom-title'>Et maintenant, envie d’essayer ?</h2>
                    <p>Demandez un rendez-vous avec l’un de nos commerciaux, il vous suffit juste de remplir le formulaire de contact.</p>
            ...
            <footer className='welcomepage__footer'>
                <img src={Logo} className='welcomepage__footer--logo' alt='Logo Paw Planner' />
                ...
                <div className='welcomepage__footer--support'>
                    ...
                    <a href='/contact' className='welcomepage__footer--button'>Contacter le support</a>
                </div>
            </footer>
        </>
    );
