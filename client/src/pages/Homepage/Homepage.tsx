		...
		<>
			<section className="homepage__section--top">
				<div className="homepage__div--top-text">
					...
					<p>
						Gérez vos plannings et suivez les progrès de chaque chien
						facilement. Quant à vous amis des chiens, prenez rendez-vous en
						ligne et suivez l'évolution de l'éducation de votre chien.
					</p>
				</div>
				...
				<div className="homepage__div--choice">
					<div className="homepage__div--choice-left">
						...
						<p className="homepage__div--choice-text">
							...
							facilement gérer vos rendez-vous, suivre les progrès de chaque
							chien et communiquer directement avec les propriétaires !
						</p>
					</div>
					<div className="homepage__div--choice-right">
						...
						<p className="homepage__div--choice-text">
							...
							disponibilités, prendre des rendez-vous en ligne et suivre
							l’évolution de votre chien. Tout est à portée de clic, pour un
							apprentissage efficace et adapté à vos besoins.
						</p>
					</div>
				</div>
			</section>
			...
			<section className="homepage__section-features">
				...
				<p className="homepage__section-features-text">
					Retrouvez les différentes fonctionnalités que vous avez sur le site,
					que vous soyez un Éducateur ou un Propriétaire.
				</p>
				{/* Cards */}
