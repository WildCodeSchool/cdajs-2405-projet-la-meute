...
describe("CategoryResolvers", () => {
	...
	beforeEach(() => {
		...
		categories = [new Category("Ex"), new Category("am"), new Category("ple")];
	});
	...
	describe("getSomeCategories", () => {
		it("should get all categories when limit is undefined", async () => {
			...
			const fetchedCategories: Category[] =
				await categoryResolver.getSomeCategories();
		...
		it("should get a number of categories depending on the limit", async () => {
			...
			const fetchedCategories: Category[] =
				await categoryResolver.getSomeCategories(limit);
	...
	describe("getCategoryById", () => {
		it("should return the category with the given id", async () => {
			...
			const fetchedCategory: Category | null =
				await categoryResolver.getCategoryById(id);
	...
	describe("createCategory", () => {
		it("should create a new category", async () => {
			...
			const createdCategory: Category | null =
				await categoryResolver.createCategory("Ex");
