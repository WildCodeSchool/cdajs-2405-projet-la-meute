...
describe("ExampleResolvers", () => {
	...
	beforeEach(() => {
		...
		examples = [new Example("Ex"), new Example("am"), new Example("ple")];
	});
	...
	describe("getSomeExamples", () => {
		it("should get all examples when limit is undefined", async () => {
			...
			const fetchedExamples: Example[] =
				await exampleResolver.getSomeExamples();
		...
		it("should get a number of examples depending on the limit", async () => {
			...
			const fetchedExamples: Example[] =
				await exampleResolver.getSomeExamples(limit);
	...
	describe("getExampleById", () => {
		it("should return the example with the given id", async () => {
			...
			const fetchedExample: Example | null =
				await exampleResolver.getExampleById(id);
